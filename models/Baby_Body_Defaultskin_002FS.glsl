...
const float cons9 = float(1.000000);
uniform vec4 unf10;
const float cons13 = float(1.000000);
uniform float unf14;
uniform vec3 unf16;
...
void main()
{
	...
	alpha_spec_correction(tmp5.rgb, cons13, unf14, tmp15);
	shade_add_mirror(unf16, tmp1, tmp11.rgb, tmp19);
	mtex_alpha_to_col(vec4(tmp19, 1.0), tmp15, tmp22);
	shade_mist_factor(varposition, unf24, unf25, unf26, unf27, unf28, tmp29);
	mix_blend(tmp29, tmp22, unf32, tmp33);
	linearrgb_to_srgb(tmp33, tmp35);
